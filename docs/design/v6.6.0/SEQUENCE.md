...
**Status as of 2026-07-08:** One doc planned — `one-app-fork-convergence.md` (6.1, sprint key ONE-FORK-CONVERGENCE). Captures downstream-fork learnings (AIPLA `cphu-aipla-app`, GDE `gde-ap-agent`) folded back into the ONE deployment.
...
| Sprint | Doc | Status |
|--------|-----|--------|
| 6.1 | [one-app-fork-convergence.md](one-app-fork-convergence.md) | Planned 2026-07-08 |

## What ships in v6.6.0

**From 6.1 (one-app-fork-convergence):**
...
v6.4.0 SHELL-MODES ✅ ───────┼─→ 6.1 one-app-fork-convergence
